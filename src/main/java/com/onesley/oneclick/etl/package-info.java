/**
 * Utility package {@code etl} — infrastructure transverse utilisée par tous les modules.
 *
 ...
 */
@ApplicationModule(type = ApplicationModule.Type.OPEN, displayName = "etl (shared infra)")
