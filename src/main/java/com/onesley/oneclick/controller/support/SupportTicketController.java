...
import com.onesley.oneclick.service.support.SupportTicketService;
...
/**
 * REST controller pour {@link SupportTicketDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "SupportTicket", description = "Auto-generated controller for support_tickets")
...
public class SupportTicketController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une SupportTicket par UUID")
