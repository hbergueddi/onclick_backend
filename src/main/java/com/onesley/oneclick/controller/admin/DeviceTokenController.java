...
import com.onesley.oneclick.service.admin.DeviceTokenService;
...
/**
 * REST controller pour {@link DeviceTokenDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "DeviceToken", description = "Auto-generated controller for device_tokens")
...
public class DeviceTokenController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une DeviceToken par UUID")
    public ResponseEntity<DeviceTokenDto> findById(@PathVariable UUID id) {
