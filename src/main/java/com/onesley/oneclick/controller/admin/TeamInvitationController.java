...
import com.onesley.oneclick.service.admin.TeamInvitationService;
...
/**
 * REST controller pour {@link TeamInvitationDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "TeamInvitation", description = "Auto-generated controller for team_invitations")
...
public class TeamInvitationController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une TeamInvitation par UUID")
    public ResponseEntity<TeamInvitationDto> findById(@PathVariable UUID id) {
