...
import com.onesley.oneclick.service.admin.AdminAuditLogService;
...
/**
 * REST controller pour {@link AdminAuditLogDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "AdminAuditLog", description = "Auto-generated controller for admin_audit_log")
...
public class AdminAuditLogController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une AdminAuditLog par UUID")
    public ResponseEntity<AdminAuditLogDto> findById(@PathVariable UUID id) {
