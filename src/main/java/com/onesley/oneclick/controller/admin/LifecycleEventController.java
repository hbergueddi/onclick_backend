...
import com.onesley.oneclick.service.admin.LifecycleEventService;
...
/**
 * REST controller pour {@link LifecycleEventDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "LifecycleEvent", description = "Auto-generated controller for lifecycle_events")
...
public class LifecycleEventController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une LifecycleEvent par UUID")
    public ResponseEntity<LifecycleEventDto> findById(@PathVariable UUID id) {
