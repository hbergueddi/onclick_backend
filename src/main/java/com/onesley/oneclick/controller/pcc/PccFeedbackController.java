...
import com.onesley.oneclick.service.pcc.PccFeedbackService;
...
/**
 * REST controller pour {@link PccFeedbackDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "PccFeedback", description = "Auto-generated controller for pcc_feedbacks")
...
public class PccFeedbackController {
    ...
    public PccFeedbackController(PccFeedbackService service) {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une PccFeedback par UUID")
    public ResponseEntity<PccFeedbackDto> findById(@PathVariable UUID id) {
