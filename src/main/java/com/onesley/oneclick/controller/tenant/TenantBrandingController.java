...
import com.onesley.oneclick.service.tenant.TenantBrandingService;
...
/**
 * REST controller pour {@link TenantBrandingDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "TenantBranding", description = "Auto-generated controller for tenant_branding")
...
public class TenantBrandingController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une TenantBranding par UUID")
    public ResponseEntity<TenantBrandingDto> findById(@PathVariable UUID id) {
