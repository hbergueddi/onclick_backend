...
import com.onesley.oneclick.service.contract.ContractTemplateService;
...
/**
 * REST controller pour {@link ContractTemplateDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "ContractTemplate", description = "Auto-generated controller for contract_templates")
...
public class ContractTemplateController {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une ContractTemplate par UUID")
    public ResponseEntity<ContractTemplateDto> findById(@PathVariable UUID id) {
