...
import com.onesley.oneclick.service.reservation.FriendGroupService;
...
/**
 * REST controller pour {@link FriendGroupDto} (généré par scripts/scaffold-jpa.mjs).
...
@Tag(name = "FriendGroup", description = "Auto-generated controller for friend_groups")
@PreAuthorize("hasAnyRole('admin','restaurateur','client')")
public class FriendGroupController {

    private final FriendGroupService service;

    public FriendGroupController(FriendGroupService service) {
    ...
    @GetMapping("/{id}")
    @Operation(summary = "Détail d'une FriendGroup par UUID")
    public ResponseEntity<FriendGroupDto> findById(@PathVariable UUID id) {
