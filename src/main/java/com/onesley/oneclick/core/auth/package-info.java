 ...
 *
 * <h3>Dépendance</h3>
 * <p>Référence {@link com.onesley.oneclick.core.identity.User} pour les FKs {@code user_id}.
 */
@ApplicationModule(displayName = "core/auth", allowedDependencies = "core/identity")
