...
public class User extends SoftDeletableAuditedEntity {
    ...
    private com.onesley.oneclick.core.tenant.Tenant tenant;
    ...
    public com.onesley.oneclick.core.tenant.Tenant getTenant() { return tenant; }
    public void setTenant(com.onesley.oneclick.core.tenant.Tenant tenant) { this.tenant = tenant; }
