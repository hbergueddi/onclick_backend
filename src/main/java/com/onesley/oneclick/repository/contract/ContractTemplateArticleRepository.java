 ...
 */
@Repository
public interface ContractTemplateArticleRepository extends JpaRepository<ContractTemplateArticle, UUID>, JpaSpecificationExecutor<ContractTemplateArticle> {
}
